...
class UnifiedLoader:
    ...
    def load_file(self, file_uuid, project_id, file_path, json_save_dir, screenshot_dir, html_save_dir):
        if file_path.endswith('.pdf'):
            self.loader = PdfLoader(file_uuid, project_id, file_path, json_save_dir, screenshot_dir, html_save_dir)
        elif file_path.startswith('http'):
            self.loader = WebLoader(file_uuid, project_id, file_path, json_save_dir, screenshot_dir, html_save_dir)
