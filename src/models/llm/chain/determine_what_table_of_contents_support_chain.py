...
from models.llm.templates.determine_what_table_of_contents_support_chain_template import SYSTEM, USER

current_file_folder_path = os.path.dirname(os.path.abspath(__file__))

class DetermineWhatTableofContentsSupportChain(BaseChatChain):
    def __init__(self, 
        ...
        self.output_keys = ['supported headings']
    ...
    def parse_output(self, output):
        ...
        values = result['supported headings']
        return values
...
## 1.2 Sales Figures and Market Evolution
## 1.3 Analysis of Global EV Market and Future Predictions
## 1.4 Opportunities and Challenges for OEMs
## 1.5 Importance of New Market Segmentation Strategies
## 1.6 Navigating Crisis and Accelerating Towards EV-Centered Future

# 2. Market Share and Consumer Interest
## 2.1 Electric Vehicle Market Share in Europe, China, and Globally
## 2.2 Factors Driving Consumer Interest in Electric Cars
## 2.3 Diminishing Concerns About Charging Infrastructure
## 2.4 Impact of Government Policies Post-COVID-19
## 2.5 Consumer Concerns Regarding Battery-Powered Electric Cars

# 3. Car Manufacturers and Industry Competition
## 3.1 Plans for Electric Vehicles by Various Manufacturers
...
# 4. Consumer Considerations and Strategies
## 4.1 Individual Considerations for Purchasing Electric Cars
## 4.2 Strategies for OEMs to Target Loyal Customers
## 4.3 Consumer Personas and Priorities for Electric Car Purchases
## 4.4 Varying Levels of Interest Across Consumer Segments
## 4.5 Efficient Marketing Strategies for Targeting Specific Consumer Groups
'''
    ...
    determine_what_table_of_contents_support_chain = DetermineWhatTableofContentsSupportChain(verbose=True)
    supported_headings = determine_what_table_of_contents_support_chain.run(table_of_contents=table_of_contents, context=context)
    print(supported_headings)
