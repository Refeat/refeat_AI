...
from models.llm.templates.extract_insights_chain_template import SYSTEM, USER

current_file_folder_path = os.path.dirname(os.path.abspath(__file__))

other_openai_api_key = os.getenv('OPENAI_API_KEY_1')

class ExtractInsightsChain(BaseChatChain):
    def __init__(self, 
