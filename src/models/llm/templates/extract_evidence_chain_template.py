...
JSON Output Generation: {{
  ...
  "concise evidence": ["Direct evidence from the text, tailored to the user's query, presented in the query language. If no relevant evidence is found, return an empty list."]
}}
