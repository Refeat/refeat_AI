...
1. Analyze the input to identify any potential issues or notable characteristics.
2. Compare the actual output with the golden output to identify differences.
3. Provide feedback on how to adjust the actual output to match the golden output.
4. Output in JSON format.
5. The JSON keys should be "input analysis", "output vs golden analysis", and "feedback".
